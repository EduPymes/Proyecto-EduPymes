...
<head>
    ...
    <title><?php echo $__env->yieldContent('title'); ?> - EduPymes</title>
...
<body>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto">
                    ...
                    <?php if(auth()->guard()->check()): ?>
                        <?php if(auth()->user()->isPyme() || auth()->user()->isAdmin()): ?>
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo e(route('vendedor.dashboard')); ?>">
                        ...
                        <?php else: ?>
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo e(route('comprador.dashboard')); ?>">
                ...
                <ul class="navbar-nav ms-auto">
                    <?php if(auth()->guard()->check()): ?>
                        <?php if(auth()->user()->isPyme() || auth()->user()->isAdmin()): ?>
                            <li class="nav-item">
                                <form method="POST" action="<?php echo e(route('logout.vendedor')); ?>" class="d-inline">
                                    <?php echo csrf_field(); ?>
                        ...
                        <?php else: ?>
                            <li class="nav-item">
                                <form method="POST" action="<?php echo e(route('logout.comprador')); ?>" class="d-inline">
                                    <?php echo csrf_field(); ?>
                                    <button type="submit" class="nav-link btn btn-link">
                                        <i class="fas fa-sign-out-alt me-1"></i>Cerrar Sesión
                                    </button>
                    ...
                    <?php else: ?>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end">
                                <li>
                                    <a class="dropdown-item" href="<?php echo e(route('login.vendedor')); ?>">
                                        <i class="fas fa-store me-2 text-primary"></i>Acceso Vendedores
                                    </a>
                                </li>
                                <li>
                                    <a class="dropdown-item" href="<?php echo e(route('login.comprador')); ?>">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end">
                                <li>
                                    <a class="dropdown-item" href="<?php echo e(route('register.vendedor')); ?>">
                                        <i class="fas fa-store me-2 text-primary"></i>Registro Vendedores
                                    </a>
                                </li>
                                <li>
                                    <a class="dropdown-item" href="<?php echo e(route('register.comprador')); ?>">
    ...
    <footer class="bg-dark text-white text-center py-4 mt-5">
        <div class="container">
            ...
            <hr>
            <p class="mb-0">&copy; <?php echo e(date('Y')); ?> EduPymes - Desarrollado por Wladimir Cortes y Gabriel Opazo</p>
        </div>
    </footer>
