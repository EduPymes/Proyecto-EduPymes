        ...
        <div class="col-md-6">
            <div class="card shadow-lg border-primary">
                ...
                <div class="card-body p-4">
                    ...
                    <form method="POST" action="<?php echo e(route('login.vendedor')); ?>">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="text-center">
                        ...
                        <a href="<?php echo e(route('register.vendedor')); ?>" class="btn btn-outline-primary">
                    ...
                    <div class="text-center mt-3">
                        ...
                        <a href="<?php echo e(route('login.comprador')); ?>" class="btn btn-outline-info">
...
<?php echo $__env->make('layouts.app', ['title' => 'Login Vendedores - EduPymes'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\example-app\resources\views/auth/login-vendedor.blade.php ENDPATH**/ ?>